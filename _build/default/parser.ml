...
# 211 "parser.ml"
    ...
    | MenhirState28 ->
        ...
        | RPAREN ->
            ...
            let _menhir_env = _menhir_discard _menhir_env in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((((_menhir_stack, _menhir_s), _), _, (e1 : (Ast.expr))), _, (e2 : (Ast.expr))), _, (e3 : (Ast.expr))) = _menhir_stack in
            let _v : (Ast.expr) = 
# 44 "parser.mly"
                                                            ( Dj_elim (e1,e2,e3) )
# 263 "parser.ml"
...
and _menhir_goto_set : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.set) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState38 ->
        ...
        | RPAREN ->
            ...
            let _menhir_env = _menhir_discard _menhir_env in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((_menhir_stack, _menhir_s), _), _, (t : (Ast.set))) = _menhir_stack in
            let _v : (Ast.set) = 
# 62 "parser.mly"
                                 ( Arrow(t,Bottom) )
# 419 "parser.ml"
    ...
    | MenhirState43 ->
        ...
        | RPAREN ->
            ...
            let _menhir_env = _menhir_discard _menhir_env in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (((_menhir_stack, _menhir_s), _, (t1 : (Ast.set))), _, (t2 : (Ast.set))) = _menhir_stack in
            let _v : (Ast.set) = 
# 57 "parser.mly"
                                               ( Arrow(t1,t2) )
# 497 "parser.ml"
...
# 541 "parser.ml"
    ...
    | MenhirState35 ->
        ...
        | RPAREN ->
            ...
            let _menhir_env = _menhir_discard _menhir_env in
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((((_menhir_stack, _menhir_s), _, (e1 : (Ast.expr))), _), _, (t : (Ast.set))) = _menhir_stack in
            let _v : (Ast.expr) = 
# 42 "parser.mly"
                                                   ( Ann(e1,t) )
# 563 "parser.ml"
    ...
    | MenhirState59 ->
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let (_menhir_stack, _menhir_s, (t : (Ast.set))) = _menhir_stack in
            let _v : (Ast.set) = 
# 37 "parser.mly"
                 ( t )
# 584 "parser.ml"
...
# 691 "parser.ml"
             in
            _menhir_goto_expr _menhir_env _menhir_stack _menhir_s _v
        | DOUBLEDOT | HOLE | LPAREN | VAR _ | WEDGE ->
...
and set_only : (Lexing.lexbuf -> token) -> Lexing.lexbuf -> (Ast.set) =
  fun lexer lexbuf ->
    let _menhir_env = {
      _menhir_lexer = lexer;
      _menhir_lexbuf = lexbuf;
